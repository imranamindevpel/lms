                    ...
                    <div class="col-sm-12">
                        <form class="" action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" min="1" name="working_hours" required placeholder="Enter Contract Hours per Week" value="{{ $user->working_hours }}"/>
                            </div>
                            <div class="form-group">
                                <label>Break Hours per Day</label>
                                <input type="number" class="form-control" min="1" name="break_minutes" required placeholder="Enter Break Hours per Day" value="{{ $user->break_minutes }}"/>
                            </div>
                            <div class="form-group">
                                <div>
